...
class ImageMixin(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        if self.image:
            from ..models import Product, ProductImage, ProductSku, ProductSkuImage, LivePhotoAlbum, LivePhotoImage
            ...
            if type(self) == Product:
                size = (225, 300)
            elif type(self) == ProductImage:
                size = (113, 150)
            elif type(self) == ProductSku:
                size = (225, 300)
            elif type(self) == ProductSkuImage:
                size = (113, 150)
            elif type(self) == LivePhotoAlbum:
                size = (450, 450)
            elif type(self) == LivePhotoImage:
